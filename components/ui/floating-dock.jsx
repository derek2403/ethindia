...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden h-12 items-end gap-2 rounded-xl bg-gray-50 px-3 py-2 md:flex dark:bg-neutral-900",
        className
      )}>
      {items.map((item) => (
...
function IconContainer({
  ...
  let heightTransformIcon = useTransform(distance, [-150, 0, 150], [16, 28, 16]);
